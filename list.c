...
// Check if head points to NULL to check if list is empty or not
...
// This funtion is to return the top of the stacks value, also known as the first linked list node value
void* return_top_val(struct list* list){
  return list->head->val;
}

// This function is to return and remove the first node of the stack/list
void* pop_from_stack(struct list* list){
